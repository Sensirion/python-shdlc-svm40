...
version_line = open("sensirion_shdlc_svm40/version.py", "rt").read()
...
setup(
    ...
    description='Driver For Communicating With Sensirion SVM40 Evaluation Kit',
    license='BSD',
    keywords='sensirion shdlc driver svm40',
    url='https://github.com/sensirion/python-shdlc-svm40',
    ...
    install_requires=[
        'sensirion-shdlc-driver[fwupdate]~=0.1.4',
